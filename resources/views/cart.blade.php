@extends('layouts.app') @section('ar')
...
<div class="container" style="margin-top: 60px">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-7 card">
            <br> @if(\Cart::getTotalQuantity()>0)
            <h4>Productos en el carrito: {{ \Cart::getTotalQuantity()}} </h4>
            <hr> @else
            <h4 class="text-center">No hay producto(s) en su carrito</h4><br>
            <a href="/tienda" class="btn btn-dark">Ir a la tienda</a><br> @endif @foreach($cartCollection as $item)
            <div class="row">
                <div class="col-lg-3">
                            ...
                            <form action="{{ route('cart.update') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control form-control-sm" value="{{ $item->quantity }}" id="quantity" name="quantity" style="width: 100%; margin-right: 10px; text-align:center;">
                                    </div>
            ...
            <hr> @endforeach @if(count($cartCollection)>0)
        ...
        <div class="col-lg-5">
            ...
            <div class="row" style="padding-right: 25px; padding-left:25px;">
                ...
                <div class="col">
                    <a id="btn-abrir-popup" class="btn btn-secondary" style="width: 100%; color:white;">Checkout</a></div>
            </div>
            ...
            <div class="overlay" id="overlay">
                <div class="popup" id="popup">
                    ...
                    <h3>My House</h3>
                    <h4>Ingrese sus datos para confirmar su pedido</h4>
                    @if(count($cartCollection)>0)
