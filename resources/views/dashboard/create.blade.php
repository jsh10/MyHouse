            ...
            <div class="container" style="padding: 20px;">
                <form action="{{ route('dashboard.store') }}" method="POST">
                    ...
                    <div class="row" style="margin-top: 14px; margin-bottom:14px;">
                        ...
                        <div class="col-md-3">
                            Ficha
                            <input type="text" class="form-control text-center" name="slug" id="slug">
                        </div>
                        <div class="col-md-3">
                            Precio
                    ...
                    <div class="row" style="margin-top: 24px; margin-bottom:24px;">
                        <div class="col-md-8">
                            ...
                            <input type="text" class="form-control text-center" name="details" id="details">
                        </div>
                        <div class="col-md-4">
                            Envio
                            <input type="number" class="form-control text-center" name="shipping_cost" id="shipping_cost">
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top: 24px; margin-bottom:24px;">
                        ...
                        <div class="col-md-4">
                            Categoria
                            <input type="number" class="form-control text-center" name="category_id" id="Category_id">
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top: 24px; margin-bottom:24px;">
                        ...
                        <div class="col-md-3">
                            Marca
                            <input type="number" class="form-control text-center" name="brand_id" id="brand_id">
                        </div>
                        <div class="col-md-9">
                            Referencia de imagen
                            <input type="text" class="form-control text-center" name="image_path" id="image_path">
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-6">
                            <button type="submit" id="checkButton"  name="" class="btn btn-success w-100">Registrar</button>
                        </div>
                        <div class="col-md-6">
